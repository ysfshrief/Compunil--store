...
const MOCK_ORDERS: Order[] = [
  { id: 'ORD-2024-001', userId: 'u1', items: [{ productId: 'p1', name: 'RTX 4080 Super', price: 42000, quantity: 1, image: '' }], total: 42000, status: 'delivered', createdAt: new Date('2024-11-01'), address: { name: 'Ahmed Mohamed', phone: '01001234567', city: 'Cairo', address: '15 Tahrir St', governorate: 'Cairo' } },
  { id: 'ORD-2024-002', userId: 'u2', items: [{ productId: 'p2', name: 'Laptop HP Elitebook', price: 28500, quantity: 1, image: '' }], total: 28500, status: 'shipped', createdAt: new Date('2024-11-08'), address: { name: 'Sara Ali', phone: '01112345678', city: 'Alexandria', address: '7 Corniche Rd', governorate: 'Alexandria' } },
  { id: 'ORD-2024-003', userId: 'u3', items: [{ productId: 'p3', name: 'Corsair RAM 32GB', price: 4800, quantity: 2, image: '' }, { productId: 'p4', name: 'Logitech G Pro X', price: 3200, quantity: 1, image: '' }], total: 12800, status: 'processing', createdAt: new Date('2024-11-10'), address: { name: 'Omar Hassan', phone: '01234567890', city: 'Giza', address: '22 Pyramids Ave', governorate: 'Giza' } },
  { id: 'ORD-2024-004', userId: 'u4', items: [{ productId: 'p5', name: 'CCTV Kit 8-Camera', price: 18500, quantity: 1, image: '' }], total: 18500, status: 'pending', createdAt: new Date('2024-11-12'), address: { name: 'Fatima Mahmoud', phone: '01098765432', city: 'Mansoura', address: '5 El Gomhoria St', governorate: 'Dakahlia' } },
  { id: 'ORD-2024-005', userId: 'u5', items: [{ productId: 'p6', name: 'TP-Link AX6000 Router', price: 8900, quantity: 1, image: '' }], total: 8900, status: 'pending', createdAt: new Date('2024-11-13'), address: { name: 'Khaled Ibrahim', phone: '01554321098', city: 'Cairo', address: '88 Nasr City', governorate: 'Cairo' } },
  { id: 'ORD-2024-006', userId: 'u6', items: [{ productId: 'p7', name: 'Samsung 980 Pro 2TB', price: 5200, quantity: 1, image: '' }], total: 5200, status: 'cancelled', createdAt: new Date('2024-11-05'), address: { name: 'Nour Samir', phone: '01223456789', city: 'Cairo', address: '3 Heliopolis', governorate: 'Cairo' } },
];
