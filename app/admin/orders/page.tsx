...
const MOCK_ORDERS: Order[] = [
  { id: 'ORD-2024-001', userId: 'u1', items: [{ productId: 'p1', productName: 'RTX 4080 Super', productImage: '', price: 42000, quantity: 1, subtotal: 42000 }], total: 42000, status: 'delivered', createdAt: new Date('2024-11-01'), address: { name: 'Ahmed Mohamed', phone: '01001234567', city: 'Cairo', address: '15 Tahrir St', governorate: 'Cairo' } },
  { id: 'ORD-2024-002', userId: 'u2', items: [{ productId: 'p2', productName: 'Laptop HP Elitebook', productImage: '', price: 28500, quantity: 1, subtotal: 28500 }], total: 28500, status: 'shipped', createdAt: new Date('2024-11-08'), address: { name: 'Sara Ali', phone: '01112345678', city: 'Alexandria', address: '7 Corniche Rd', governorate: 'Alexandria' } },
  { id: 'ORD-2024-003', userId: 'u3', items: [{ productId: 'p3', productName: 'Corsair RAM 32GB', productImage: '', price: 4800, quantity: 2, subtotal: 9600 }, { productId: 'p4', productName: 'Logitech G Pro X', productImage: '', price: 3200, quantity: 1, subtotal: 3200 }], total: 12800, status: 'processing', createdAt: new Date('2024-11-10'), address: { name: 'Omar Hassan', phone: '01234567890', city: 'Giza', address: '22 Pyramids Ave', governorate: 'Giza' } },
  { id: 'ORD-2024-004', userId: 'u4', items: [{ productId: 'p5', productName: 'CCTV Kit 8-Camera', productImage: '', price: 18500, quantity: 1, subtotal: 18500 }], total: 18500, status: 'pending', createdAt: new Date('2024-11-12'), address: { name: 'Fatima Mahmoud', phone: '01098765432', city: 'Mansoura', address: '5 El Gomhoria St', governorate: 'Dakahlia' } },
  { id: 'ORD-2024-005', userId: 'u5', items: [{ productId: 'p6', productName: 'TP-Link AX6000 Router', productImage: '', price: 8900, quantity: 1, subtotal: 8900 }], total: 8900, status: 'pending', createdAt: new Date('2024-11-13'), address: { name: 'Khaled Ibrahim', phone: '01554321098', city: 'Cairo', address: '88 Nasr City', governorate: 'Cairo' } },
  { id: 'ORD-2024-006', userId: 'u6', items: [{ productId: 'p7', productName: 'Samsung 980 Pro 2TB', productImage: '', price: 5200, quantity: 1, subtotal: 5200 }], total: 5200, status: 'cancelled', createdAt: new Date('2024-11-05'), address: { name: 'Nour Samir', phone: '01223456789', city: 'Cairo', address: '3 Heliopolis', governorate: 'Cairo' } },
];
                ...
                {filtered.length === 0 ? (
                  ...
                  <tr key={order.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-4 py-3 hidden sm:table-cell">
                      <div className="text-sm text-gray-700">{order.address?.name || '—'}</div>
              ...
              <div className="flex-1 overflow-y-auto p-5 space-y-5">
                ...
                <div>
                  ...
                  <div className="bg-gray-50 rounded-xl p-4 space-y-1.5 text-sm">
                    <div><span className="text-gray-400">Name: </span><span className="font-medium">{selectedOrder.address?.name}</span></div>
                    <div><span className="text-gray-400">Phone: </span><span className="font-medium">{selectedOrder.address?.phone}</span></div>
                    <div><span className="text-gray-400">Address: </span><span className="font-medium">{selectedOrder.address?.address}</span></div>
