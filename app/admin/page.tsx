...
const MOCK_STATS: DashboardStats = {
  ...
  pendingOrders: 7,
  recentOrders: [
    { id: 'ord-001', userId: 'u1', items: [], total: 18500, status: 'pending', createdAt: new Date(Date.now() - 3600000) },
    { id: 'ord-002', userId: 'u2', items: [], total: 42000, status: 'processing', createdAt: new Date(Date.now() - 7200000) },
    { id: 'ord-003', userId: 'u3', items: [], total: 9800, status: 'shipped', createdAt: new Date(Date.now() - 86400000) },
    { id: 'ord-004', userId: 'u4', items: [], total: 155000, status: 'delivered', createdAt: new Date(Date.now() - 172800000) },
    { id: 'ord-005', userId: 'u5', items: [], total: 28000, status: 'pending', createdAt: new Date(Date.now() - 259200000) },
  ],
  lowStockProducts: [
