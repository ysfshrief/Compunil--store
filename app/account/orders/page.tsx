...
const MOCK_USER_ORDERS: Order[] = [
  {
    ...
    address: { name: 'Ahmed Mohamed', phone: '01001234567', city: 'Cairo', address: '15 Tahrir St', governorate: 'Cairo' },
  },
  {
    id: 'ORD-2024-003',
    userId: 'u1',
    ...
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <div className="bg-gradient-to-r from-brand-navy to-brand-teal rounded-2xl p-5 text-white mb-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="font-bold text-lg">{user.displayName || 'Customer'}</div>
